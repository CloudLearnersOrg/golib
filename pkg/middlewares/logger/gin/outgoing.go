...
// OutgoingLogger wraps http.Client to log outgoing requests with Gin context support
...
// Do performs an HTTP request and logs the details using Gin context
func (o *OutgoingLogger) Do(c *gin.Context, req *http.Request) (*http.Response, error) {
	start := time.Now()

	// Get trace ID from Gin context or request header
